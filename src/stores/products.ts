...
export const useProductsStore = defineStore("products", () => {
  ...
  async function init() {
    ...
    products.value = [
      ...
      },
      {
        ...
        name: "Gerbera",
        color: "Pink",
        description: "Like in barbie movie",
  ...
  function getProductByID(productID: number) {
    ...
    return {
      ...
      quantity:
        carted.content.find((el) => el.productID == productID)?.quantity || 0,
    };
  }
  ...
  async function cartChangeProductQuantity(
    ...
    let targetElement = carted.content.find((el) => el.productID == productID);
